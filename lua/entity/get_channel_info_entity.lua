...
local GetChannelInfoEntity = {}
GetChannelInfoEntity.__index = GetChannelInfoEntity


function GetChannelInfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetChannelInfoEntity)
  self._name = "get_channel_info"
  self._client = client
...
function GetChannelInfoEntity:get_name()
  return self._name
end


function GetChannelInfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetChannelInfoEntity.new(self._client, opts)
end


function GetChannelInfoEntity:data_set(args)
  if args ~= nil then
...
function GetChannelInfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetChannelInfoEntity:match_set(args)
  if args ~= nil then
...
function GetChannelInfoEntity:match_get()
...
function GetChannelInfoEntity:stream(action, args, callopts)
...
---@param reqmatch GetChannelInfoLoadMatch
---@param ctrl? table
---@return GetChannelInfo
---@return string? err
function GetChannelInfoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetChannelInfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
