...
describe("GetChannelInfoDirect", function()
  it("should direct-load-get_channel_info", function()
    local setup = get_channel_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_channel_info", setup.live and "live" or "unit")
...
function get_channel_info_direct_setup(mockres)
