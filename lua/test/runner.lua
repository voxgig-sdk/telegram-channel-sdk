...
function runner.env_override(m)
  local live = runner.getenv("TELEGRAMCHANNEL_TEST_LIVE")
  local override = runner.getenv("TELEGRAMCHANNEL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TELEGRAMCHANNEL_TEST_EXPLAIN")
