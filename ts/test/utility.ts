...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.TELEGRAMCHANNEL_TEST_LIVE ||
    'TRUE' === process.env.TELEGRAMCHANNEL_TEST_OVERRIDE
  ) {
  ...
  m.TELEGRAMCHANNEL_TEST_EXPLAIN = process.env.TELEGRAMCHANNEL_TEST_EXPLAIN || m.TELEGRAMCHANNEL_TEST_EXPLAIN
