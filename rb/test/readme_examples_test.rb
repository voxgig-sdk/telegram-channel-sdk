...
#      offline in seeded test mode (TelegramChannelSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TelegramChannel_sdk.rb")
  SDK_CLASS = "TelegramChannelSDK"
