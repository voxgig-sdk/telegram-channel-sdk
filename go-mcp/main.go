// Command TelegramChannel-mcp is an MCP server exposing the TelegramChannel
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TelegramChannel_list  — list records of an entity
//	TelegramChannel_load  — load a single record of an entity
//
