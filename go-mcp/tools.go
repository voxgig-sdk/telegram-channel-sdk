...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_channel_info"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TelegramChannelSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "telegram-channel_list",
		Description: "List records from TelegramChannel. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "telegram-channel_load",
		Description: "Load a single record from TelegramChannel. " +
...
func runOp(client *sdk.TelegramChannelSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TelegramChannelSDK, name string) (sdk.TelegramChannelEntity, error) {
	switch strings.ToLower(name) {
	case "get_channel_info":
		return client.GetChannelInfo(nil), nil
