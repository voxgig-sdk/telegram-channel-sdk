...
// TelegramChannel SDK rbac feature
...
class TelegramChannelRbacFeature extends TelegramChannelBaseFeature
{
    ...
    private function _required(TelegramChannelContext $ctx): ?string
    {
    ...
    private function _reject(TelegramChannelContext $ctx, string $required): void
    {
    ...
    private function _track(TelegramChannelContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
