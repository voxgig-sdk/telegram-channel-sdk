...
// TelegramChannel SDK proxy feature
...
class TelegramChannelProxyFeature extends TelegramChannelBaseFeature
{
    ...
    public function init(TelegramChannelContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TelegramChannelContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
