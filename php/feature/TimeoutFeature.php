...
// TelegramChannel SDK timeout feature
...
class TelegramChannelTimeoutFeature extends TelegramChannelBaseFeature
{
    ...
    private function _with_timeout(TelegramChannelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TelegramChannelContext $_ctx, float $ms): void
    {
        $client = $this->client;
