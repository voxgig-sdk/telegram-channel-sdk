...
// TelegramChannel SDK clienttrack feature
...
class TelegramChannelClienttrackFeature extends TelegramChannelBaseFeature
{
    ...
    public function PostConstruct(TelegramChannelContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TelegramChannel-SDK';
