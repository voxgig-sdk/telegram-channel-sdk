...
// TelegramChannel SDK idempotency feature
...
class TelegramChannelIdempotencyFeature extends TelegramChannelBaseFeature
{
    ...
    private function _mutating(TelegramChannelContext $ctx): bool
    {
