...
// TelegramChannel SDK cache feature
...
class TelegramChannelCacheFeature extends TelegramChannelBaseFeature
{
    ...
    private function _through(TelegramChannelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
