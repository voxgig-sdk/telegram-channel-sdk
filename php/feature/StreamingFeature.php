...
// TelegramChannel SDK streaming feature
...
class TelegramChannelStreamingFeature extends TelegramChannelBaseFeature
{
    ...
    private function _iterate(TelegramChannelResult $result): \Generator
    {
    ...
    private function _streamable(TelegramChannelContext $ctx): bool
    {
