# TelegramChannel PHP SDK Reference

Complete API reference for the TelegramChannel PHP SDK.
...
#### `TelegramChannelSDK::test($testopts = null, $sdkopts = null)`
