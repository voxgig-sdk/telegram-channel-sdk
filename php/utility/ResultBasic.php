...
// TelegramChannel SDK utility: result_basic

class TelegramChannelResultBasic
{
    public static function call(TelegramChannelContext $ctx): ?TelegramChannelResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof TelegramChannelError) ? $result->err->msg : (string)$result->err;
