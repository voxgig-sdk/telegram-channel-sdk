...
// TelegramChannel SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TelegramChannelMakeRequest
{
    public static function call(TelegramChannelContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TelegramChannelResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TelegramChannelResponse($fetched);
        } else {
