...
// TelegramChannel SDK utility type

class TelegramChannelUtility
{
    ...
    public static function copy(TelegramChannelUtility $src): TelegramChannelUtility
    {
        $u = new TelegramChannelUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
