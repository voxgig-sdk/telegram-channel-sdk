...
// TelegramChannel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TelegramChannelSDK::test)
...
{
    private const SDK_CLASS = 'TelegramChannelSDK';
    ...
    private const SDK_BASE = 'telegramchannel_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../telegramchannel_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
