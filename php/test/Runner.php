...
class TelegramChannelTestRunner
{
    ...
    {
        $live = self::getenv('TELEGRAMCHANNEL_TEST_LIVE');
        $override = self::getenv('TELEGRAMCHANNEL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TELEGRAMCHANNEL_TEST_EXPLAIN');
...
class_alias('TelegramChannelTestRunner', 'Runner');
class_alias('TelegramChannelHelpers', 'Helpers');
