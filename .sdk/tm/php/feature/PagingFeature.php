...
// TelegramChannel SDK paging feature
...
class TelegramChannelPagingFeature extends TelegramChannelBaseFeature
{
    ...
    private function _is_list(TelegramChannelContext $ctx): bool
    {
