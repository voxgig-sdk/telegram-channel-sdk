...
// TelegramChannel SDK audit feature
...
class TelegramChannelAuditFeature extends TelegramChannelBaseFeature
{
    ...
    private function _emit(TelegramChannelContext $ctx, string $outcome): void
    {
