...
// TelegramChannel SDK netsim feature
...
class TelegramChannelNetsimFeature extends TelegramChannelBaseFeature
{
    ...
    private function _simulate(TelegramChannelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TelegramChannelContext $ctx, array $applied): void
    {
        $client = $this->client;
