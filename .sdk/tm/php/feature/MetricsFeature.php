...
// TelegramChannel SDK metrics feature
...
class TelegramChannelMetricsFeature extends TelegramChannelBaseFeature
{
    ...
    private function _record(TelegramChannelContext $ctx, bool $ok): void
    {
