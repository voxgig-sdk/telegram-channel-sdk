...
// TelegramChannel SDK ratelimit feature
...
class TelegramChannelRatelimitFeature extends TelegramChannelBaseFeature
{
    ...
    private function _acquire(TelegramChannelContext $ctx): void
    {
    ...
    private function _track(TelegramChannelContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
