...
// TelegramChannel SDK telemetry feature
...
class TelegramChannelTelemetryFeature extends TelegramChannelBaseFeature
{
    ...
    private function _close(TelegramChannelContext $ctx, bool $ok): void
    {
