...
// TelegramChannel SDK debug feature
...
class TelegramChannelDebugFeature extends TelegramChannelBaseFeature
{
    ...
    private function _finish(TelegramChannelContext $ctx, bool $ok): void
    {
