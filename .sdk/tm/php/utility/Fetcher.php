...
// TelegramChannel SDK utility: fetcher
...
class TelegramChannelFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TelegramChannelSDK/1.0)';
    ...
    public static function call(TelegramChannelContext $ctx, string $fullurl, array $fetchdef): array
    {
