...
// TelegramChannel SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TelegramChannelTransformResponse
{
    public static function call(TelegramChannelContext $ctx): mixed
    {
        ...
        $transform = TelegramChannelHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
