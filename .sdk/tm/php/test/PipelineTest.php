...
// TelegramChannel SDK pipeline test
//
...
{
    private static function utility(): TelegramChannelUtility
    {
        return new TelegramChannelUtility();
    }
    ...
    private static function ctx(array $over = []): TelegramChannelContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TelegramChannelContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TelegramChannelOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TelegramChannelError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TelegramChannelOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TelegramChannelMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TelegramChannelOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TelegramChannelMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TelegramChannelOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TelegramChannelMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TelegramChannelSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TelegramChannelMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TelegramChannelResponse([]),
            'result' => new TelegramChannelResult([]),
        ]);
        [, $err] = TelegramChannelMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TelegramChannelSpec([]),
            'response' => null,
            'result' => new TelegramChannelResult([]),
        ]);
        [, $err] = TelegramChannelMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TelegramChannelSpec(['step' => 's']),
            'response' => new TelegramChannelResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TelegramChannelResult([]),
        ]);
        [, $err] = TelegramChannelMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TelegramChannelSpec(['step' => 's']),
            'response' => new TelegramChannelResponse(self::resp(200, ['v' => 1])),
            'result' => new TelegramChannelResult([]),
        ]);
        [, $err] = TelegramChannelMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TelegramChannelSpec(['step' => 's']),
            'response' => new TelegramChannelResponse(self::resp(200, ['v' => 2])),
            'result' => new TelegramChannelResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TelegramChannelMakeResponse::call($ctx);
    ...
    {
        $preset = new TelegramChannelResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TelegramChannelSpec([]),
            'response' => new TelegramChannelResponse([]),
            'result' => new TelegramChannelResult([]),
        ...
        [$got, $err] = TelegramChannelMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TelegramChannelResult([])]);
        [, $err] = TelegramChannelMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TelegramChannelSpec([]), 'result' => null]);
        [, $err] = TelegramChannelMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TelegramChannelSpec(['step' => 's']),
            'result' => new TelegramChannelResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TelegramChannelOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TelegramChannelMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TelegramChannelSpec(['step' => 's']),
            'result' => new TelegramChannelResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TelegramChannelOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TelegramChannelMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TelegramChannelResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TelegramChannelSpec([]),
            'result' => new TelegramChannelResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TelegramChannelMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TelegramChannelMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TelegramChannelError('boom', 'boom');
        $utility->fetcher = function (TelegramChannelContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TelegramChannelSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TelegramChannelMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TelegramChannelContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TelegramChannelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TelegramChannelResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TelegramChannelMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TelegramChannelContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TelegramChannelSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TelegramChannelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TelegramChannelResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TelegramChannelSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TelegramChannelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TelegramChannelMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TelegramChannelMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TelegramChannelResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TelegramChannelDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TelegramChannelResult(['ok' => false])]);
        $this->expectException(TelegramChannelError::class);
        TelegramChannelDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TelegramChannelResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TelegramChannelMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TelegramChannelMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TelegramChannelBaseFeature();
        $b = new TelegramChannelBaseFeature();
        TelegramChannelFeatureAdd::call($ctx, $a);
        TelegramChannelFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TelegramChannelBaseFeature
    {
        $f = new TelegramChannelBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TelegramChannelFeatureAdd::call($ctx, self::named_feature('a'));
        TelegramChannelFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TelegramChannelFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TelegramChannelFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TelegramChannelFeatureAdd::call($ctx, $replace);
        ...
        TelegramChannelFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TelegramChannelContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TelegramChannelSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TelegramChannelPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TelegramChannelPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TelegramChannelResponse(['headers' => null]),
            'result' => new TelegramChannelResult([]),
        ]);
        TelegramChannelResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TelegramChannelResultBody::call($ctx);
