...
func registerSDKWords(r *eng.Registry, client *sdk.TelegramChannelSDK) {
...
func runOp(client *sdk.TelegramChannelSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
