# TelegramChannel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TelegramChannelSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TelegramChannelSDK(...) and TelegramChannelSDK.test(...) become
#      TelegramChannelSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "telegramchannel_sdk"
_SDK_CLASS = "TelegramChannelSDK"
