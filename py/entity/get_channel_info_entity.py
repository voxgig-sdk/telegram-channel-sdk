...
from telegramchannel_types import (
    GetChannelInfo,
...
class GetChannelInfoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetChannelInfoEntity(self._client, opts)
    ...
    def data_get(self) -> GetChannelInfo:
    ...
    def match_get(self) -> GetChannelInfo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetChannelInfo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetChannelInfo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
