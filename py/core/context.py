...
from core.control import TelegramChannelControl
...
class TelegramChannelContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TelegramChannelControl()
        ...
        if isinstance(sp, TelegramChannelSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TelegramChannelResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TelegramChannelResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TelegramChannelOperation({})
    ...
    def make_error(self, code, msg):
        return TelegramChannelError(code, msg, self)
