...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/telegram-channel` | `npm install @voxgig-sdk/telegram-channel` |
| Python | `voxgig-sdk-telegram-channel` | `pip install voxgig-sdk-telegram-channel` |
| PHP | `voxgig-sdk/telegram-channel` | `composer require voxgig-sdk/telegram-channel` |
| Golang | `github.com/voxgig-sdk/telegram-channel-sdk/go` | `go get github.com/voxgig-sdk/telegram-channel-sdk/go` |
| Ruby | `voxgig-sdk-telegram-channel` | `gem install voxgig-sdk-telegram-channel` |
| Lua | `voxgig-sdk-telegram-channel` | `luarocks install voxgig-sdk-telegram-channel` |
